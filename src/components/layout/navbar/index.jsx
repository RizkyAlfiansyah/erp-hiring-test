...
import { CancelSVG, MenuSVG } from '../../../assets/icons';

const { navbar, navbar_responsive, navbar_content, button } = Styles;
  ...
  return (
    <>
      ...
      <div className={navbar_responsive}>
        ...
        <MenuSVG onClick={(e) => setShow(true)} />
      </div>
      {show ? (
        <div className={navbar_content}>
          <CancelSVG onClick={() => setShow(false)} />
          {navItems.map((item, index) => {
            return (
              <h3 key={index} onClick={() => onClick(index)}>
                {item}
              </h3>
            );
          })}
